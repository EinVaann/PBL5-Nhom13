...
void setup() {
 ...
 WiFi.begin(wifiName, password);
  ...
  dht.begin();
  Serial.println("Chọn chức năng:");
  Serial.println("1: Xem nhiệt độ, độ ẩm:");
  Serial.println("2: Xem ngày:");
  Serial.println("3: Xem giờ:");
  Serial.println("4: Ghi âm:"); 
  Serial.println("5: Server down File:"); 
}
