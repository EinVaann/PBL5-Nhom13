...
const char*  server = "pbl5api.pagekite.me";  // Server URL
...
//Send file to Server
void CheckDevice(){
  if (!client.connect("pbl5api.pagekite.me", 443))
    Serial.println("Connection failed!");
  else {
    client.println("GET /base/status/1/ HTTP/1.1");
    client.println("Host: pbl5api.pagekite.me");
...
void SendFile(DFRobotDFPlayerMini myDFPlayer){
  if (!client.connect("pbl5api.pagekite.me", 443))
    ...
    if(!fp){
      ...
      postHeader += "Host: pbl5api.pagekite.me\r\n";
